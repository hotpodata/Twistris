...
import kotlinx.android.synthetic.main.fragment_dialog_pause.*

/**
 * Created by jdrotos on 12/28/15.
 */
class DialogPauseFragment : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater?.inflate(R.layout.fragment_dialog_pause, container, false)
    }
